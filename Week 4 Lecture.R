...
# Construct a table with the average number of calls per household by region in waves 1 and 10
# You’ll need to use the following data tables: household data from wave 1 and 10 
# (a_gor_dv and h_gor_dv identify region) and call records from waves 1 and 10 
...
# at this stage you need to check in the codebook that the numerical codes for regions are the same in waves 1 and 10 (they are)
